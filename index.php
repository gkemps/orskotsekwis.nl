...
<body class="front-page ">
  ...
  <div class="page-wrapper">
    ...
    <div id="banner" class="banner dark-translucent-bg padding-bottom-clear"
      style="background-image:url('images/oirschot.png');">
      <!-- section start -->
      <!-- ================ -->
      <div class="container">
              ...
              <div class="call-to-action text-center">
                <div class="row">
                  <?php if (time() < END_OF_SUBSCRIPTION): ?>
                    <div <?php if (time() > START_OF_SUBSCRIPTION && time() < END_OF_SUBSCRIPTION): ?>class="col-md-8"
                      <?php else: ?>class="col-md-12" <?php endif ?><! <h1 class="title">Inschrijven - nog
                      <?php $dagen = ceil(($nextDeadline - time()) / (60 * 60 * 24));
                      echo ($dagen > 1) ? "{$dagen} dagen" : "{$dagen} dag" ?>
                      </h1>
                      <?php if (time() > START_OF_SUBSCRIPTION): ?>
                        <p>Schrijf jouw team in via de button hiernaast. Lees eerst: <a href="#" data-toggle="modal"
                            data-target="#myModal">goed om te weten als teamcaptain</a></p>
                      <?php else: ?>
                        <p>Inschrijving opent woensdag 3 januari. Lees eerst: <a href="#" data-toggle="modal"
                            data-target="#myModal">goed om te weten als teamcaptain</a></p>
                        <h2>De <a href="UitslagOrskotseKwis2023.pdf" style="color: #22B573">uitslag</a> van 2023 is bekend!
                          Download hier het boekje van 2023 inclusief <a href="OrskotseKwisAntwoordenboekSite2023.pdf"
                            style="color: #22B573">antwoorden</a>.</h2>
                      <?php endif ?>
                    </div>
                    <?php if (time() > START_OF_SUBSCRIPTION && time() < END_OF_SUBSCRIPTION): ?>
                      <div class="col-md-4">
                        <br>
                        <p>
                          <button data-toggle="modal" data-target="#myStep1Modal"
                            class="btn btn-lg btn-default btn-animated">Inschrijven<i
                              class="fa fa-pencil pl-20"></i></button>
                        </p>
                      </div>
                    <?php endif ?>
                  <?php else: ?>
                    <div class="col-md-12">
                      ...
                      <h2>De <a href="Uitslag2024.pdf" style="color: #22B573">uitslag</a> van 2024 is bekend! Download
                        hier het boekje van 2024 inclusief <a href="AntwoordenboekOrskotseKwisSiteDef2024.pdf"
                          style="color: #22B573">antwoorden</a>.</h2>
                    </div>
                  <?php endif ?>
                </div>
        ...
        <div class="container">
            <div class="clients-container"> 
                <div class="clients">
                    ...
                    <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200">
                        <a href="https://sabiencanton.nl/" target="_blank"><img src="images/sponsors/Logo-SabienCanton.png" alt=""></a>
                    </div>
                    <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200">
